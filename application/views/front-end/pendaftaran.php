...
<head>
  ...
  <title>Rekrutmen Online | <?php echo $user['nama_lengkap']; ?></title>
  <link rel="icon" href="assets/images/jr.png" type="image/x-icon" />
            ...
            <div style="margin-top:-8px;">
              <h2>
                <strong class="text-primary">
                  <a href=""><span style="margin-left:40px;color:#fff;">Rekrutmen Online PPSU </span></a>
                </strong>
              </h2>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          <div class="header" style="margin-top:-20px; text-align: center;">
            <img src="img/jayaraya.png" style="margin-bottom:10px;" width="100"><br>
            <h2 align="center">FORM PENDAFTARAN REKRUTMEN ONLINE <strong> <br><?php echo $user['nama_lengkap']; ?></strong></h2>
                    ...
                    <div class="wizard-div current wizard-sea" id="register">
                      <form role="form" class="wizard wizard-validation" data-style="sky" role="form" action="" enctype="multipart/form-data" method="post">
                        <fieldset>
                          ...
                          <div class="col-md-8">
                            <?php $this->load->view('front-end/step/1'); ?>
                            <div class="col-md-12">
                              <span class="text-primary" style="font-size:18px;color:#222;"><strong>Apakah Anda setuju dengan ketentuan rekrutmen online PPSU di atas?</strong></span>
                              <div class="form-group" style="padding-bottom:30px;">
                                <div class="radio bg-success" style="padding-top:10px;padding-bottom:10px;border-radius:3px;color:#222;">
                                  <label>
                                    <input type="radio" value="cek" name="cek" data-parsley-group="block0" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="condition-ck"]' required> <b>Ya, saya menyetujui ketentuan rekrutmen online PPSU!</b>
                                  </label>
                        ...
                        <fieldset>
                          ...
                          <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                              <?php $this->load->view('front-end/step/2'); ?>
                            </div>
                          </div>
                            ...
                            <div class="col-md-8">
                              <div class="panel">
                                <div class="panel-heading" style="background: #fd9a05; color: honeydew;">
                                  <h2 align="center" style="margin-top: 10px;">KONFIRMASI<br><b>DATA PELAMAR PETUGAS PPSU</b> </h2>
                                </div>
                                <div class="panel-body">
                                  <span style="font-size:15px">
                                    <p align="center">Proses pendaftaran rekrutmen online <?php echo $user['nama_lengkap']; ?> hampir selesai. <br>Silakan periksa kembali data-data yang sudah anda masukkan.</p><br><br>
                                    <div class="col-md-12">
                                      <span class="text-primary" style="font-size:18px;"><strong>Apakah data Anda sudah sesuai?</strong></span>
            ...
            <div class="footer">
              <div class="copyright">
                ...
                <p class="pull-right sm-pull-reset">
                  <span><a href="" class="m-r-10"><i class="fa fa-home"></i> Beranda </a> | <a href="#" class="m-l-10 m-r-10" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-legal"></i> Ketentuan & Syarat Rekrutmen PPSU</a></span>
                </p>
              </div>
            </div>
          </div>
