...
<div class="category-content no-padding">
	<ul class="navigation navigation-main navigation-accordion">
		...
		<li class="<?php if ($menu == 'Ctrl_admin' and $sub_menu == 'data_pelamar' or $sub_menu == 'edit_materi') {
						echo 'active';
					} ?>"><a href="Ctrl_admin/data_pelamar"><i class="icon-file-check"></i> <span><b>DATA PENDAFTARAN</b></span></a></li>

		<li class="<?php if ($menu == 'Ctrl_admin' and $sub_menu == 'data_penilaian') {
			echo 'active';
		} ?>"><a href="Ctrl_admin/data_penilaian"><i class="icon-file-excel"></i> <span><b>DATA BERKAS ADMINISTRASI</b></span></a></li>
		...
		<li class="<?php if ($menu == 'Ctrl_admin' and $sub_menu == 'hasil_penilaian') {
						echo 'active';
					} ?>"><a href="Ctrl_admin/hasil_penilaian"><i class="icon-clipboard"></i> <span><b>HASIL PENILAIAN</b></span></a></li>
