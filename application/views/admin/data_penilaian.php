...
<div class="content-wrapper">
	...
	<div class="content">
		...
		<!-- /dashboard content -->
		<?php foreach ($data_berkas as $baris) {
			$baris = (array)$baris; ?>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header bg-primary">
							<h5 class="modal-title text-white">Form Penilaian</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
							<form action="Ctrl_admin/simpan_nilai" method="POST">
								...
								<div class="form-group">
									<label>BUKTI KTP : </label>
									<a href="" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal_pict<?php echo $baris['id_pendaftaran']; ?>" title="Lihat Gambar">LIHAT BUKTI KTP</a>
									<br>
									<label for="exampleInputnoktp">INPUT BOBOT PENILAIAN PARAMETER PENDUDUK</label>
									<select class="form-select form-select-lg mb-3" name="parameter_penduduk" aria-label=".form-select-lg example">
										<?php $no = 0;
								...
								<div class="form-group">
									<label>BUKTI KK : </label>
									<a href="" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal_kk<?php echo $baris['id_pendaftaran']; ?>" title="Lihat Gambar">LIHAT BUKTI KK</a>
									<br>
									<label for="exampleInputnoktp">INPUT BOBOT PENILAIAN PARAMETER KELUARGA</label>
									<select class="form-select form-select-lg mb-3" name="parameter_keluarga" aria-label=".form-select-lg example">
										<?php $no = 0;
								...
								<div class="form-group">
									...
									<a href="" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal_per<?php echo $baris['id_pendaftaran']; ?>" title="Lihat Gambar">LIHAT BUKTI PERNYATAAN</a>
									<br>
									<label for="exampleInputnoktp">INPUT BOBOT PENILAIAN PARAMETER PERNYATAAN</label>
									<select class="form-select form-select-lg mb-3" name="parameter_pernyataan" aria-label=".form-select-lg example">
										<?php $no = 0;
						...
						<div class="modal-footer">
							<br>
							<button type="submit" name="btnNilai" class="btn btn-primary">Save Penilaian</button>
